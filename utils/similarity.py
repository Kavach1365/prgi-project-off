...
def get_soundex_similarity(new_title: str, existing_title: str) -> bool:
    ...
    """
    new_title_normalized = normalize_text(new_title)
    existing_title_normalized = normalize_text(existing_title)
    return jellyfish.soundex(new_title_normalized) == jellyfish.soundex(existing_title_normalized)
